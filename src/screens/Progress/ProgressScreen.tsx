...
const s = StyleSheet.create({
  ...
  periodRow:     { flexDirection: 'row', backgroundColor: 'rgba(255,240,220,0.06)', borderRadius: 8, padding: 2, gap: 2 },
  ...
  prRowBorder:   { borderBottomWidth: 1, borderBottomColor: 'rgba(255,240,220,0.07)' },
  ...
  heatBox:       { width: '100%', aspectRatio: 1, borderRadius: 6, backgroundColor: 'rgba(255,240,220,0.10)' },
