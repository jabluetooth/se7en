...
const s = StyleSheet.create({
  ...
  stepDot:          { width: 24, height: 24, borderRadius: 12, backgroundColor: 'rgba(255,240,220,0.08)', borderWidth: 1, borderColor: 'rgba(255,240,220,0.14)', alignItems: 'center', justifyContent: 'center', overflow: 'hidden' },
  ...
  stepCheckmark:    { fontSize: 13, fontWeight: '800', fontFamily: FONTS.display, color: '#000' },
  stepNum:          { fontSize: 11, fontWeight: '800', fontFamily: FONTS.display, color: COLORS.textMuted },
  stepNumActive:    { color: COLORS.accent },
  stepLabel:        { fontSize: 12, fontWeight: '600', fontFamily: FONTS.semibold, color: COLORS.textMuted },
  stepLabelActive:  { color: '#fff', fontWeight: '700', fontFamily: FONTS.headline },
  stepLine:         { width: 20, height: 2, backgroundColor: 'rgba(255,240,220,0.12)', borderRadius: 1, marginLeft: 2 },
  stepLineDone:     { backgroundColor: COLORS.accent },
  scroll:           { paddingHorizontal: 20 },
  fieldLabel:       { fontSize: 11, fontWeight: '700', fontFamily: FONTS.label, color: COLORS.textMuted, letterSpacing: 0.88, textTransform: 'uppercase', marginBottom: 8, marginTop: 16 },
  nameInput:        { backgroundColor: 'rgba(255,240,220,0.06)', borderWidth: 1, borderColor: 'rgba(255,240,220,0.12)', borderRadius: 12, height: 52, paddingHorizontal: 16, color: '#fff', fontSize: 17, fontWeight: '600', fontFamily: FONTS.semibold },
  typeBtn:          { flexDirection: 'row', alignItems: 'center', gap: 14, padding: 12, borderRadius: 12, marginBottom: 6, backgroundColor: 'rgba(255,240,220,0.05)', borderWidth: 1, borderColor: 'rgba(255,240,220,0.10)' },
  typeBtnActive:    { backgroundColor: 'rgba(255,140,0,0.10)', borderColor: 'rgba(255,140,0,0.40)' },
  typeIcon:         { width: 34, height: 34, borderRadius: 10, backgroundColor: 'rgba(255,240,220,0.08)', alignItems: 'center', justifyContent: 'center', overflow: 'hidden' },
  typeIconActive:   {},
  typeIconGrad:     { width: 34, height: 34, alignItems: 'center', justifyContent: 'center', borderRadius: 10 },
  typeIconText:     { fontSize: 14, fontWeight: '700', fontFamily: FONTS.headline, color: COLORS.textMuted },
  typeIconTextActive: { fontSize: 14, fontWeight: '700', fontFamily: FONTS.headline, color: '#000' },
  typeName:         { fontSize: 15, fontWeight: '700', fontFamily: FONTS.headline, color: '#fff', letterSpacing: -0.45 },
  ...
  unitText:         { paddingHorizontal: 16, paddingVertical: 10, fontSize: 13, fontWeight: '700', fontFamily: FONTS.headline, color: COLORS.textMuted, backgroundColor: 'rgba(255,240,220,0.06)', borderRadius: 10, borderWidth: 1, borderColor: 'rgba(255,240,220,0.12)', overflow: 'hidden' },
  unitTextActive:   { fontSize: 13, fontWeight: '700', fontFamily: FONTS.headline, color: '#000' },
  barBtn:           { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', padding: 12, borderRadius: 12, marginBottom: 6, backgroundColor: 'rgba(255,240,220,0.05)', borderWidth: 1, borderColor: 'rgba(255,240,220,0.10)' },
  barBtnActive:     { backgroundColor: 'rgba(255,140,0,0.10)', borderColor: 'rgba(255,140,0,0.35)' },
  ...
  reviewName:       { fontSize: 22, fontWeight: '800', fontFamily: FONTS.display, color: '#fff', letterSpacing: -0.88, marginBottom: 8 },
  ...
  reviewRowBorder:  { borderBottomWidth: 1, borderBottomColor: 'rgba(255,240,220,0.07)' },
  reviewLbl:        { fontSize: 14, fontFamily: FONTS.body, color: COLORS.textSecondary },
  reviewVal:        { fontSize: 14, fontWeight: '700', fontFamily: FONTS.headline, color: '#fff' },
  ...
  backNavText:      { fontSize: 15, fontWeight: '600', fontFamily: FONTS.semibold, color: COLORS.textSecondary },
  nextBtn:          { flex: 1, borderRadius: 14, overflow: 'hidden' },
  nextGrad:         { height: 54, alignItems: 'center', justifyContent: 'center', borderRadius: 14 },
  nextText:         { fontSize: 16, fontWeight: '800', fontFamily: FONTS.display, color: '#000', letterSpacing: -0.64 },
});
