...
const s = StyleSheet.create({
  ...
  nameInput:        { backgroundColor: 'rgba(255,240,220,0.06)', borderWidth: 1, borderColor: 'rgba(255,240,220,0.12)', borderRadius: 12, height: 52, paddingHorizontal: 16, color: '#fff', fontSize: 17, fontWeight: '600' },
  ...
  unitText:         { paddingHorizontal: 16, paddingVertical: 10, fontSize: 13, fontWeight: '700', color: COLORS.textMuted, backgroundColor: 'rgba(255,240,220,0.06)', borderRadius: 10, borderWidth: 1, borderColor: 'rgba(255,240,220,0.12)', overflow: 'hidden' },
  ...
  notesInput:       { backgroundColor: 'rgba(255,240,220,0.05)', borderWidth: 1, borderColor: 'rgba(255,240,220,0.10)', borderRadius: 12, padding: 12, color: '#fff', fontSize: 14, minHeight: 80 },
