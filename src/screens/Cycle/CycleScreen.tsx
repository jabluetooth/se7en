...
// ─── Swipe actions (shared Edit / Clear — appears on both left and right swipe) ─

const DAY_ACTIONS_WIDTH = 200;

// Swipe LEFT → reveals from the right edge
...
function DoneAction({ dragX, onPress }: { dragX: Animated.AnimatedInterpolation<number>; onPress: () => void }) {
  const translateX = dragX.interpolate({
